...
from app.api.endpoints import services, investigations, chat, test, traces, bedrock_usage, dashboards, investigations_ai

api_router = APIRouter()

api_router.include_router(services.router, prefix="/services", tags=["services"])
api_router.include_router(investigations.router, prefix="/investigations", tags=["investigations"])
api_router.include_router(investigations_ai.router, prefix="/investigations", tags=["investigations-ai"])
